...
seed = 1             # For random generation of the position of the orbits
...
system1.Plot2D(ax1, (-1.5, 1.5), (-1.5, 1.5))
...
system2.Plot2D(ax2, (-2.5,1), (-2.5,1))

plt.show()

# Example 2: A 3D plot

system1.Plot3D((-1.5, 1.5), (-1.5, 1.5))
system2.Plot3D((-2.5,1), (-2.5,1))
